...
#' 
#' @description CAVE: This functions is not updated regularly and just
#' included as stand alone file to avoid additional dependencies. Check 
#' the similiarly named function in the dataAnalysisMisc package on
#' http://github.com/mknoll/dataAnalysisMisc/ for updates.
#' 
#' @import parallel
#' @import doParallel
#' @import foreach
